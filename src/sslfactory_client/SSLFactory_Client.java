...
public class SSLFactory_Client {
    ...
    private SSLContext createSSLContext(){
       try{
           ...
           keyStore.load(new FileInputStream("C:\\Program Files\\Java\\jre1.8.0_181\\lib\\security\\cacerts"),"changeit".toCharArray());        
           // Create key manager
